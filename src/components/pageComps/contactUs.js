...
let figText = [
  ...
  'Nowhere City, Alaska',
  <br />,
  'Phone: 1-543-912-5693',
];
let figText2 = [
  'Cyclone Technolgy was voted happiest place on earth',
  <br />,
  'Just look how happy our employees are!',
];
    ...
    <div className='pageBody'>
      <div className='contactsBody'>
        ...
        <div className='contactsBtn'>
          <Button
            variant='contained'
            style={{ backgroundColor: 'RGB(1, 42, 74)' }}
        ...
        <figure className='contactsLogo'>
          <img
            className='contacts'
            src={happy}
            alt='Happy Employees smiling ina group'
          />
